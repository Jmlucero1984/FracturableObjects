    ...
    execute: function () {
      ...
      _export("WholeDelaunay", WholeDelaunay = (_dec = ccclass('WholeDelaunay'), _dec(_class = class WholeDelaunay {
        ...
        findFracture() {
          ...
          console.log(this.delFracInstance.delaunayPoints.length);
          var points = [];
          ...
          console.log("FRACTURAAAA-WHOLEDELAUNAY");
          console.log(points);
        ...
        removeOutRunners(verts) {
          ...
          for (var j = 0; j < cant; ++j) {
            ...
            var maxAngle = this.getRelativeAngle(v1, v2);
            ...
            if (a.links.length > 0) {
              for (var k = 0; k < a.links.length; k++) {
                if (a.links[k] != null) {
                  ...
                  var angle = this.getRelativeAngle(v1, v2);
...
//# sourceMappingURL=a73121f089463b0ee908405d9ffea8b8f46b7872.js.map