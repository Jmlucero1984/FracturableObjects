      ...
      _export("SingleContact", SingleContact = (_dec = ccclass('SingleContact'), _dec(_class = class SingleContact extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          contact.getWorldManifold().points.forEach(element => {
            var localPos = this.node.getComponent(UITransform).convertToNodeSpaceAR(v3(element.x, element.y, 0));
            console.log("LOCAL: " + localPos);
          });
          var velA = selfCollider.body ? selfCollider.body.linearVelocity : 0;
          var velB = otherCollider.body ? otherCollider.body.linearVelocity : 0;
...
//# sourceMappingURL=a4577aa509e64c22a4c8ed3f0df410c152220f17.js.map