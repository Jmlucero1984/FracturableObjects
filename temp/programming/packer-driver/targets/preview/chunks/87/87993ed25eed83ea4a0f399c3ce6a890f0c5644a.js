System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function getFracturable(fracture) {
    ...
    console.log(fractPoints);
    console.log("INTERNALS length: " + internals.length);
    console.log(internals);
    removeVertexs(fractPoints, internals);
    console.log("INTERNALS new  length: " + internals.length);
    var i = 0;
    var continuar = true;
    ...
    console.log("POINS A BEFORE OUTRUNNERS");
    console.log(partA);
    console.log("POINS B BEFORE OUTRUNNERS");
    console.log(partB);
    ...
    console.log("POINS A AFTER OUTRUNNERS");
    console.log(partA);
    console.log("POINS B AFTER OUTRUNNERS");
    console.log(partB);
    ret.push(partA);
    ret.push(partB);
    return ret;
...
//# sourceMappingURL=87993ed25eed83ea4a0f399c3ce6a890f0c5644a.js.map