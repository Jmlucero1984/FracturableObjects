System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function findFracture(fracture) {
    ...
    for (var i = 0; i < fracture.getDelaunayPoints().size; i++) {
      var element = fracture.getDelaunayPoints().entries[i];
    ...
    var bIndex = findClosestIndex(points[points.size - 1], fracture.getDelaunayPoints());
  ...
  function reverse(pVs) {
    for (var index = 0; index < pVs.size / 2; index++) {
  ...
  function findClosestIndex(pos, pVs) {
    for (var index = 0; index < pVs.size; index++) {
      var element = pVs[index];
  ...
  function getFracturable(fracture) {
    ...
    var internals = deepCopy(fracture.getDelaunayPoints(), false); // let partA: plainVertex[] = []
    ...
    while (continuar) {
      if (i == pointA) {
        ...
        for (var _j = fractPoints.size - 1; _j > 0; _j--) {
    ...
    execute: function () {
      ...
      _export("DelaunayFracture", DelaunayFracture = class DelaunayFracture {
        constructor(ctPt, normal, envd, plainVertexs) {
          ...
          this.pointA = void 0;
          this.pointB = void 0;
          this.fracturePoints = new Set();
          this.envolvent = void 0;
          this.extremePoints = void 0;
          this.delaunayPoints = new Set();
...
//# sourceMappingURL=3370cc841b683eabbd49e03ab567048a2346d360.js.map