System.register(["cc"], function (_export, _context) {
  ...
  function getRelativeAngle(vecA, vecB) {
    ...
    var transformedVectorB = new Vec2(vecB.x * Math.cos(rads) + vecB.y * Math.sin(rads), vecB.x * Math.sin(rads) + vecB.y * Math.cos(rads));
...
//# sourceMappingURL=ee7376c5300a3a2f7e962f4e7b6acff3d1950270.js.map