    ...
    execute: function () {
      ...
      _export("UnitTest", UnitTest = (_dec = ccclass('UnitTest'), _dec2 = property(RichText), _dec(_class = executeInEditMode(_class = (_class2 = class UnitTest extends Component {
        ...
        EarcutAreaCasitaTest() {
          ...
          return Math.abs((_crd && calculateEnvolArea === void 0 ? (_reportPossibleCrUseOfcalculateEnvolArea({
            error: Error()
          }), calculateEnvolArea) : calculateEnvolArea)(indexes, nums, 2) - 32.25) < 0.01;
        }
...
//# sourceMappingURL=fbe271102b83d760ab29eece6c02f109957e020f.js.map