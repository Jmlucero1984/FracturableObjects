System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Vec2, getRelativeAngle, removeOutRunners, plainVertex, linkNode, DelaunayFracture, _crd, ccclass, property;
  ...
  function findFracture(fracture) {
    ...
    // console.log("CONTACT POINT: " + fracture.getContactPoint())
    // console.log("NEAREST: " + fracture.getDelaunayPoints()[nearestIndex])


    points.push(fracture.getDelaunayPoints()[nearestIndex]); //   console.log("DIRECTION " + direction)
  ...
  function promdireccion(vecA, vecB) {
  ...
  */
  ...
  function getFracturable(fracture) {
    ...
    var partA = [];
    var partB = [];
    var externals = deepCopy(fracture.getDelaunayPoints(), true); //  console.log("INTERNALS")
    // console.log(internals)
    // console.log("EXTERNALS")
    //  console.log(externals)
    // console.log("POINT A :" +fracture.getPointA())
    //  console.log("POINT B :" +fracture.getPointB())

    var fractPoints = fracture.getFracturePts(); // NO OLVIDAR EL TEMA DE SI TOCA EL PRIMER VERTICE!!!!
    ...
    while (continuar) {
      ...
      i++; //   console.log("_INTERNAL_PARTS A LENGTH: "+partA.length+"  PARTS B: "+partB.length)
    } //
    //  console.log("---A---: "+ partA.length)
    // console.log(partA)
    // console.log("---B---: "+partB.length)
    // console.log(partB)
    // console.log("INTERNALS")
    // console.log(internals)
    ...
    (_crd && removeOutRunners === void 0 ? (_reportPossibleCrUseOfremoveOutRunners({
      error: Error()
    }), removeOutRunners) : removeOutRunners)(partA); //  console.log(partA)
    //   console.log(">>PART B")

    (_crd && removeOutRunners === void 0 ? (_reportPossibleCrUseOfremoveOutRunners({
      error: Error()
    }), removeOutRunners) : removeOutRunners)(partB); //  console.log(partB)
...
//# sourceMappingURL=81d3134890f95976e899b711ddc5832801409f26.js.map