    ...
    execute: function () {
      ...
      _export("GeneralManager", GeneralManager = (_dec = ccclass('GeneralManager'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Label), _dec7 = property(Node), _dec8 = property(Prefab), _dec(_class = (_class2 = class GeneralManager extends Component {
        ...
        onLoad() {
          ...
          var clickEventHandler = this.createClickEventHandler(this.node, "GeneralManager", "showPanel", "");

          if (this.showPanelButton != null) {
            this.showPanelButton.clickEvents.push(clickEventHandler);
          }

          var clickDetonate = this.createClickEventHandler(this.node, "GeneralManager", "detonateAll", "");
          ...
          for (var _i = 2; _i < 5; _i++) {
            for (var _j = 1; _j < 4; _j++) {
              console.log("Resultado mult " + _i + " * " + _j + " : " + getIdx(v2(_i, _j)));
            }
          }
        }
        ...
        showPanel(event, customEventData) {
          ...
          if (this.bluePrint != null) {
            if (!this.bluePrintOn) {
              ...
              var tempIndex = this.bluePrint.getSiblingIndex();
        ...
        placeDetonator(relativePos) {
          ...
          var node = instantiate(this.detonator);
          this.counter += 0.2;
          ...
          var dims = v2(this.nodeStruc.getComponent(UITransform).width, this.nodeStruc.getComponent(UITransform).height);
...
//# sourceMappingURL=d199461c3f6744766b0b5c55d1c3bea46a2a9984.js.map