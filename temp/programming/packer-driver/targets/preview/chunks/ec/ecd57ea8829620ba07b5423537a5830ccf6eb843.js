  ...
  function getFracturable(fracture) {
    ...
    if (partA.length > 3) {
      internals.forEach(element => {
        if (!alreadyPlaced(element, partA)) partA.push(cloneVertexPlain(element));
      });
    }

    if (partB.length > 3) {
      internals.forEach(element => {
        if (!alreadyPlaced(element, partB)) partB.push(cloneVertexPlain(element));
      });
    }
...
//# sourceMappingURL=ecd57ea8829620ba07b5423537a5830ccf6eb843.js.map