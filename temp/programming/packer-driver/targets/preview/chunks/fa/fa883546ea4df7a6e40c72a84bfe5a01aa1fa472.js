System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, RichText, Vec2, linkNode, findClosestAngle, earcut, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, executeInEditMode, UnitTest;
    ...
    execute: function () {
      ...
      _export("UnitTest", UnitTest = (_dec = ccclass('UnitTest'), _dec2 = property(RichText), _dec(_class = executeInEditMode(_class = (_class2 = class UnitTest extends Component {
        ...
        onEnable() {
          ...
          tests.push(this.EarcutAreaTest);
          tests.forEach(t => {
        ...
        EarcutAreaTest() {
          ...
          console.log((_crd && earcut === void 0 ? (_reportPossibleCrUseOfearcut({
            error: Error()
...
//# sourceMappingURL=fa883546ea4df7a6e40c72a84bfe5a01aa1fa472.js.map