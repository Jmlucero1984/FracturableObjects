  ...
  return {
    ...
    execute: function () {
      ...
      _export("Voronoi", Voronoi = (_dec = ccclass('Voronoi'), _dec(_class = class Voronoi extends Graphics {
        ...
        start() {
          var vertices = []; //vertices.push(new Point(20,40))
        ...
        Compute(p, width, height) {
          ...
          for (var _i = 0; _i < this.edges.length; _i++) if (this.edges[_i].neighbour) this.edges[_i].start = this.edges[_i].neighbour.end;
        }
        ...
        drawEdges(e) {
          ...
          for (var i = 0; i < e.length; i++) {
            var n = e[i]; //  if(n.end==null) {n.end=n.left}
...
//# sourceMappingURL=79030e4ea313a5b72c453dd53c1f4e3ed538347e.js.map