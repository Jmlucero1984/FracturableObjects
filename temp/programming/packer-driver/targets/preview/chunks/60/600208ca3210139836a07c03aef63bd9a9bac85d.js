System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, RichText, Vec2, linkNode, calculateEnvolArea_2, findClosestAngle, earcut, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, executeInEditMode, UnitTest;
  ...
  function _reportPossibleCrUseOfcalculateEnvolArea_(extras) {
    _reporterNs.report("calculateEnvolArea_2", "./DelaunaySplitter", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      calculateEnvolArea_2 = _unresolved_3.calculateEnvolArea_2;
    ...
    execute: function () {
      ...
      _export("UnitTest", UnitTest = (_dec = ccclass('UnitTest'), _dec2 = property(RichText), _dec(_class = executeInEditMode(_class = (_class2 = class UnitTest extends Component {
        ...
        EarcutAreaCasitaTest() {
          ...
          var areaCalculated = (_crd && calculateEnvolArea_2 === void 0 ? (_reportPossibleCrUseOfcalculateEnvolArea_({
            error: Error()
          }), calculateEnvolArea_2) : calculateEnvolArea_2)(indexes, nums);
          console.log("AREA CALCULATED: " + areaCalculated);
          var areaExpected = 31.25;
        ...
        AngleTest1() {
          ...
          return (_crd && findClosestAngle === void 0 ? (_reportPossibleCrUseOffindClosestAngle({
            error: Error()
          }), findClosestAngle) : findClosestAngle)(UnitTest.degToRad(359), linksNodesTest) == 1;
        }
...
//# sourceMappingURL=600208ca3210139836a07c03aef63bd9a9bac85d.js.map