        ...
        elementReleased(dragabbleItemNode) {
          if (this.actualNode != null) {
            ...
            if (this.actualNode.name == "StructureContainer") {
              ...
              var worldPos = dragabbleItemNode.getWorldPosition();
              dragabbleItemNode.setParent(this.structureNode);
              dragabbleItemNode.setWorldPosition(worldPos);
              var dimsStruc = new Vec2(this.structureNode.getComponent(UITransform).width, this.structureNode.getComponent(UITransform).height);
              var dimsItem = new Vec2(dragabbleItemNode.getComponent(UITransform).width / 2, dragabbleItemNode.getComponent(UITransform).height / 2);
...
//# sourceMappingURL=5e13341145926f058ca3ab7975f18930fd6e85ba.js.map