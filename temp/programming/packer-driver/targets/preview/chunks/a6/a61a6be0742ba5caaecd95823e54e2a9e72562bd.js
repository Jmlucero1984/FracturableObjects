    ...
    execute: function () {
      ...
      _export("UnitTest", UnitTest = (_dec = ccclass('UnitTest'), _dec2 = property(RichText), _dec(_class = executeInEditMode(_class = (_class2 = class UnitTest extends Component {
        ...
        EarcutAreaCasitaTest() {
          ...
          var areaCalculated = (_crd && calculateEnvolArea2D === void 0 ? (_reportPossibleCrUseOfcalculateEnvolArea2D({
            error: Error()
        ...
        EarcutAreaHexagonoTest() {
          ...
          console.log("AREA CALCULATED: " + areaCalculated);
          var areaExpected = 21.807;
          return Math.abs(areaCalculated - areaExpected) < 0.1;
        }

        EarcutAreaEstrellaTest() {
          var nums = [];
          nums = [-0.10, -0.88, 2.6, 2.16, 5.29, -0.88, 4, 2.97, 7.98, 3.78, 5.29, 8.45, 2.60, 5.41, -0.1, 8.45, 1.19, 4.59, -2.79, 3.78, 1.19, 2.97];
          var indexes = (_crd && earcut === void 0 ? (_reportPossibleCrUseOfearcut({
            error: Error()
          }), earcut) : earcut)(nums, null, 2);
          console.log("INDEXES: " + indexes);
...
//# sourceMappingURL=a61a6be0742ba5caaecd95823e54e2a9e72562bd.js.map