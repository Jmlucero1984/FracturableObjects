      ...
      _export("StaticFractureManager", StaticFractureManager = (_dec = ccclass('StaticFractureManager'), _dec(_class = (_class2 = class StaticFractureManager extends Component {
        ...
        static createCopy(frac) {
          ...
          if (parts != null) {
            ...
            var minArea = 300;
            var a1 = (_crd && calculateEnvolArea2D === void 0 ? (_reportPossibleCrUseOfcalculateEnvolArea2D({
              error: Error()
            ...
            var a2 = (_crd && calculateEnvolArea2D === void 0 ? (_reportPossibleCrUseOfcalculateEnvolArea2D({
              error: Error()
            }), calculateEnvolArea2D) : calculateEnvolArea2D)((_crd && earcut === void 0 ? (_reportPossibleCrUseOfearcut({
              error: Error()
...
//# sourceMappingURL=970a9f417227a47545ba3658531a8d88144b926b.js.map