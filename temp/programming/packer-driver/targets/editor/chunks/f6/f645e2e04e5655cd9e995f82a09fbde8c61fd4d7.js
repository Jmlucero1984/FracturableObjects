System.register(["cc"], function (_export, _context) {
  ...
  function filterNulls(elementsArr) {
    for (let i = 0; i < elementsArr.size; i++) {
      if (elementsArr[i] == null) {
        for (let j = i + 1; j < elementsArr.size; j++) {
    ...
    for (let i = elementsArr.size - 1; i > 0; i--) {
      if (elementsArr[i] == null) elementsArr.delete;
    }
  }
...
//# sourceMappingURL=f645e2e04e5655cd9e995f82a09fbde8c61fd4d7.js.map