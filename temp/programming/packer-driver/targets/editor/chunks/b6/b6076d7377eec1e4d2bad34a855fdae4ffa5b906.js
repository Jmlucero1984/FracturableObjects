System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function findFracture(fracture) {
    ...
    for (let i = 0; i < fracture.getDelaunayPoints().size; i++) {
      let element = fracture.getDelaunayPoints().entries[i];
  ...
  function getFracturable(fracture) {
    ...
    const internals = deepCopy(fracture.getDelaunayPoints(), false); // let partA: plainVertex[] = []
...
//# sourceMappingURL=b6076d7377eec1e4d2bad34a855fdae4ffa5b906.js.map