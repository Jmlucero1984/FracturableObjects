System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, PolygonCollider2D, Vec2, Vec3, FractDelaunay, calcAproxArea, calculateEnvolArea2D, getFracturable, DelaunayAssemblerImplementer, earcut, Queue, _dec, _class, _class2, _crd, ccclass, property, StaticFractureManager;
    ...
    execute: function () {
      ...
      _export("StaticFractureManager", StaticFractureManager = (_dec = ccclass('StaticFractureManager'), _dec(_class = (_class2 = class StaticFractureManager extends Component {
        ...
        static createCopy(frac) {
          ...
          if (parts != null) {
            let nodeF = frac.node;
            let a1 = (_crd && calcAproxArea === void 0 ? (_reportPossibleCrUseOfcalcAproxArea({
              error: Error()
            }), calcAproxArea) : calcAproxArea)(parts[0]);
            let a2 = (_crd && calcAproxArea === void 0 ? (_reportPossibleCrUseOfcalcAproxArea({
              error: Error()
            ...
            console.log("REAL AREA 1: " + (_crd && calculateEnvolArea2D === void 0 ? (_reportPossibleCrUseOfcalculateEnvolArea2D({
              error: Error()
            ...
            console.log("REAL AREA 2: " + (_crd && calculateEnvolArea2D === void 0 ? (_reportPossibleCrUseOfcalculateEnvolArea2D({
              error: Error()
            }), calculateEnvolArea2D) : calculateEnvolArea2D)((_crd && earcut === void 0 ? (_reportPossibleCrUseOfearcut({
              error: Error()
...
//# sourceMappingURL=128fdd5f0f592422c1e19f40635a98f6e4946e17.js.map