System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfcalculateEnvolArea(extras) {
    _reporterNs.report("calculateEnvolArea", "./MaskSplitter", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "30f6ad0y/hEKJ1n9jMeSGqZ", "FracturableAssembler", undefined);

      __checkObsolete__(['_decorator', 'Component', 'Node', 'Graphics', 'Vec2', 'Color', '__private', 'UIVertexFormat', 'gfx', 'warnID', 'director', 'RenderingSubMesh', 'Vec3', 'v2', 'Texture2D', 'Size', 'size', 'Material', 'MeshRenderData', 'math']);
      ...
      _export("FracturableAssembler", FracturableAssembler = (_dec = ccclass('FracturableAssembler'), _dec2 = property({
        group: "Render"
      }), _dec3 = property(Texture2D), _dec4 = property({
        group: "Render"
      }), _dec5 = property(Material), _dec6 = property({
        type: [Vec2]
      }), _dec(_class = (_class2 = class FracturableAssembler extends Graphics {
        constructor(...args) {
          super(...args);
        ...
        _flushAssembler() {
          ...
          superGraphicsAssembler._expandStroke = function (graphics) {
            ...
            if (true) {
              //   console.log("POINTS")
              //   console.log(polygonPoints)
              let theUvs = computeUv(polygonPoints, textureWidth, textureHeight); //  console.log(theUvs)
              ...
              area = (_crd && calculateEnvolArea === void 0 ? (_reportPossibleCrUseOfcalculateEnvolArea({
                error: Error()
              }), calculateEnvolArea) : calculateEnvolArea)(indexes, earcutData, 3);
...
//# sourceMappingURL=f011e6971d69e9bbd59c0adac02f2e9e9326c062.js.map