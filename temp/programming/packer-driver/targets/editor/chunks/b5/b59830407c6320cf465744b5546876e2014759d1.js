    ...
    execute: function () {
      ...
      _export("UnitTest", UnitTest = (_dec = ccclass('UnitTest'), _dec2 = property(RichText), _dec(_class = executeInEditMode(_class = (_class2 = class UnitTest extends Component {
        ...
        EarcutAreaCasitaTest() {
          ...
          let areaCalculated = (_crd && calculateEnvolArea === void 0 ? (_reportPossibleCrUseOfcalculateEnvolArea({
            error: Error()
          }), calculateEnvolArea) : calculateEnvolArea)(indexes, nums, 5);
...
//# sourceMappingURL=b59830407c6320cf465744b5546876e2014759d1.js.map