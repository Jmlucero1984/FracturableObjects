        ...
        static createCopy(frac) {
          ...
          if (parts != null) {
            ...
            true) {
              ...
              console.log("REAL AREA 1: " + frac.implementer.getArea());
              ...
              copyOf.getComponent(_crd && DelaunayAssemblerImplementer === void 0 ? (_reportPossibleCrUseOfDelaunayAssemblerImplementer({
                error: Error()
              }), DelaunayAssemblerImplementer) : DelaunayAssemblerImplementer).customLoad(points2);
              console.log("REAL AREA 2: " + cfwa.implementer.getArea()); //copyOf.getComponent(DelaunayAssemblerImplementer).markForUpdateRenderData();
...
//# sourceMappingURL=721a1ab22f2fddcc25a152f0ceb1d1088b23d0c4.js.map