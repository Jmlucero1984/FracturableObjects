        ...
        */
        ...
        removeOutRunners(verts) {
          ...
          for (let j = 0; j < cant; ++j) {
            ...
            let maxAngle = this.getRelativeAngle(v1, v2); //    console.log("POS  x: "+a.x+"  y: "+a.y)
            ...
            if (a.links.length > 0) {
              for (let k = 0; k < a.links.length; k++) {
                if (a.links[k] != null) {
                  ...
                  let angle = this.getRelativeAngle(v1, v2); //    console.log("A LINK item  x: "+a.links[k].x+"   y: "+a.links[k].y)
                  //  console.log(angle)
...
//# sourceMappingURL=0ed2d76b79efc17b4b802e9d2cf8cf29f36497ac.js.map