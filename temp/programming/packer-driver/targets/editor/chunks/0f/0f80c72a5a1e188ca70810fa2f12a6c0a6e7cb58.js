System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, RichText, Vec2, linkNode, TestAngles, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, executeInEditMode, UnitTest;
  ...
  return {
    ...
    execute: function () {
      ...
      TestAngles = class TestAngles {
        constructor() {
          this.vectores = void 0;
          this.angulos = void 0;
          this.tests = void 0;
      ...
      _export("UnitTest", UnitTest = (_dec = ccclass('UnitTest'), _dec2 = property(RichText), _dec(_class = executeInEditMode(_class = (_class2 = class UnitTest extends Component {
        ...
        onEnable() {
          let testAngles = new TestAngles();
          setTimeout(() => {
            testAngles.executeTest();
          }, 50);
...
//# sourceMappingURL=0f80c72a5a1e188ca70810fa2f12a6c0a6e7cb58.js.map