System.register(["cc"], function (_export, _context) {
  ...
  function getRelativeAngle(vecA, vecB) {
    ...
    let transformedVectorB = new Vec2(vecB.x * Math.cos(rads) + vecB.y * Math.sin(rads), vecB.x * Math.sin(rads) + vecB.y * Math.cos(rads));
...
//# sourceMappingURL=d95f751a585dfdfb9451f6cac1a9ff864cf7e6ef.js.map